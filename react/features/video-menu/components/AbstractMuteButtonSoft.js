...
import { MuteRemoteParticipantDialogSoft } from '.';
 ...
 */
export default class AbstractMuteButtonSoft extends AbstractButton<Props, *> {
    ...
    _handleClick() {
        ...
        dispatch(openDialog(MuteRemoteParticipantDialogSoft, { participantID }));
    }
