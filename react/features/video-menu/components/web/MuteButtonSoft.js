...
import AbstractMuteButtonSoft, {
    _mapStateToProps,
    type Props
} from '../AbstractMuteButtonSoft';
 ...
 */
class MuteButtonSoft extends AbstractMuteButtonSoft {
    /**
...
export default translate(connect(_mapStateToProps)(MuteButtonSoft));
